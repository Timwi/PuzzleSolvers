...
namespace PuzzleSolvers.Exotic
{
    ...
    ///     puzzles.</remarks>
    public class YSumUniquenessConstraint : PermutationUniquenessConstraint
    {
        ...
        public YSumUniquenessConstraint(int sum, IEnumerable<int> affectedCells, int minValue = 1, int maxValue = 9)
