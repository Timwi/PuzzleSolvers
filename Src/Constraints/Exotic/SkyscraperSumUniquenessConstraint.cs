...
public class SkyscraperSumUniquenessConstraint(int clue, IEnumerable<int> affectedCells, int minValue = 1, int maxValue = 9)
    : PermutationUniquenessConstraint(affectedCells, generateCombinations(minValue, maxValue, clue, affectedCells.Count()))
{
