...
namespace PuzzleSolvers
{
    ...
    public class AntiBishopConstraint(int gridWidth, int gridHeight, int[] affectedValues = null, IEnumerable<int> enforcedCells = null) : AntiChessConstraint(gridWidth, gridHeight, affectedValues, enforcedCells)
    {
