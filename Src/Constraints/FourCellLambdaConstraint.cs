...
namespace PuzzleSolvers
{
    ...
    public class FourCellLambdaConstraint(int affectedCell1, int affectedCell2, int affectedCell3, int affectedCell4, Func<int, int, int, int, bool> isValid)
        : Constraint([affectedCell1, affectedCell2, affectedCell3, affectedCell4])
    {
        /// <summary>A function that determines whether a set of values is valid in the relevant cells.</summary>
        public Func<int, int, int, int, bool> IsValid { get; private set; } = isValid;
